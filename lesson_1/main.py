...
async def main():
    async with LiteClient.from_mainnet_config(ls_i=7, trust_level=2) as client:
        ...
        wallet = await WalletV4R2.from_mnemonic(client, "better retreat forward blouse unhappy balcony gravity light comfort crime crawl struggle maximum rib trust best lucky brain express swap muscle aware inflict issue")
        print(wallet)
